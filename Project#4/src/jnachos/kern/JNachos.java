...
public abstract class JNachos {
	...
	/**
	 *	a Process Table which is used to keep track the NachoProcesses
	 */
	public static HashMap<Integer, NachosProcess> ProcessTable;
	
    public static HashMap<String, NachosProcess> ProcessNameTable;
	
    //Buffer pool
	public static BufferPool mBufferPool;

	/**
	 *	a waiting Table, NachoProcess 'a' is blocked because of 'b'
	 */
	...
	public static void initialize(String args[]) {
		...
		//initialize the processNameTable
		ProcessNameTable = new HashMap<String, NachosProcess>();
